...
验证证据=build 0 error；全量 test 3053/3053 pass；contract/invariant 24/24 pass（--no-build 回退复验）；hotspot PASS；active_rule_path=D:/OneDrive/CODE/ClassroomToolkit/AGENTS.md (source=project-doc)
