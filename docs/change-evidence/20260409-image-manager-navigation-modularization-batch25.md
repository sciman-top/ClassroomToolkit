...
当前落点=ImageManagerWindow.xaml.cs 混合导航/收藏夹/目录解析逻辑，文件复杂且变更冲突概率高
目标归宿=将导航与收藏夹方法组迁移到独立 partial，主文件聚焦扫描与缩略图调度
迁移批次=2026-04-09-maintainability-hardening-batch25
风险等级=低
执行命令=
...
- 热点体量下降：ImageManagerWindow.xaml.cs 从 863 降到 407（预算 1540，delta 从 -677 改善到 -1133）
回滚动作=
- git checkout -- src/ClassroomToolkit.App/Photos/ImageManagerWindow.xaml.cs
- git checkout -- src/ClassroomToolkit.App/Photos/ImageManagerWindow.Navigation.cs
