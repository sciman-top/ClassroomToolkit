# 20260710 Agent Rule Contract v2 - ClassroomToolkit
...
## Verification
- `python D:\CODE\governed-ai-coding-runtime\scripts\verify-target-project-rules.py --targets ClassroomToolkit --require-all`
...
- 工作树边界：本轮前工作树无无关改动；历史规则文件保留在 Git 历史中。
