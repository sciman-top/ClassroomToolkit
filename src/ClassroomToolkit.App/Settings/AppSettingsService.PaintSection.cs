...
public sealed partial class AppSettingsService
{
    ...
    {
        settings.BrushSize = NormalizeBrushSize(GetDouble(paint, "brush_base_size", settings.BrushSize), settings.BrushSize);
        ...
        AppSettings settings)
    {
        ...
        paint["brush_base_size"] = NormalizeBrushSize(settings.BrushSize, defaults.BrushSize).ToString("0.##", CultureInfo.InvariantCulture);
        paint["quick_brush_size_1"] = NormalizeBrushSize(settings.QuickBrushSize1, defaults.QuickBrushSize1).ToString("0.##", CultureInfo.InvariantCulture);
        paint["quick_brush_size_2"] = NormalizeBrushSize(settings.QuickBrushSize2, defaults.QuickBrushSize2).ToString("0.##", CultureInfo.InvariantCulture);
        paint["quick_brush_size_3"] = NormalizeBrushSize(settings.QuickBrushSize3, defaults.QuickBrushSize3).ToString("0.##", CultureInfo.InvariantCulture);
