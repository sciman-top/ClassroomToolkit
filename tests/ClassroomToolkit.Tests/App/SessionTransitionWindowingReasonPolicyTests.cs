...
public sealed class SessionTransitionWindowingReasonPolicyTests
{
    [Theory]
    [InlineData(0, "none")]
    ...
    {
        SessionTransitionWindowingReasonPolicy.ResolveTag((SessionTransitionWindowingReason)reasonValue)
            .Should()
            .Be(expectedTag);
    }
}
